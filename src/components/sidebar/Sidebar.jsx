...
<li className='sidebarListItem'><LineStyle className='sidebarIcon' />Home</li>
...
<Link to='/products' className='link'><li className='sidebarListItem'><Storefront className='sidebarIcon' />Productions</li></Link>
...
<li className='sidebarListItem'><ChatBubbleOutline className='sidebarIcon'/>Message</li>
